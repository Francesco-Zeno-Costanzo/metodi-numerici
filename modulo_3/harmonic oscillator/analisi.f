	...
	real*8, dimension(:), allocatable :: y2, dy2
	real*8, dimension(:), allocatable :: c
	real*8 :: daver_y2, daver_dy2
	integer :: R
	common N, R
	...
	do j = 1, nret
		...
		aver_dy2 = sum(dy2)/float(N)
		
		call errore(y2, daver_y2)
		call errore(dy2, daver_dy2)
		
		
		write(2,*) aver_y2, daver_y2, aver_dy2, daver_dy2
	enddo
...
C=============================================================================
	...
	!bisogna tenere conto di una possibile correlazione frai i dati
    	...
    	Dd = 2**12			!dimensione dei blocchi	
